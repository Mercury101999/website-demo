...
<html>
	...
	<body style="min-width: 980px;">
		...
		<div class="home-welcome">
			<div class="home-welcome-text" style="background-image: url(image/back.gif); height: 380px; ">
				<div style="padding-top: 180px;">
					<div style=" background-color: #dadbe6;">
					</div>
					<h1 style="margin: 0px;">Wall-E</h1>
					<h2>electronics</h2>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/NoodlesCanned.php">
							<img src="./image/product/drone2.jpeg" class="home-prodlist-imgi">
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/Snacks.php">
							<img src="./image/product/dogrob.jpeg" class="home-prodlist-imgi">
							<h3 style="text-align: center;">Dog AIBOs</h3>
						</a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="OurProducts/Sweets.php">
							<img src="./image/product/humrob.jpeg" class="home-prodlist-imgi">
							<h3 style="text-align: center;">Humanoid AIBOs</h3>
						</a>
						</div>
					</li>
				</ul>
